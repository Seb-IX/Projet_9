...
from utils import  ContentCollaboratifFiltering
from azure.storage.blob import BlobServiceClient, __version__
import os

########### CHARGEMENT DES FICHIERS ###############
file_download = "final_df.csv"
...
try:
    ...
    # Améliorer pour paramètrer depuis un fichier de configuration ?
    model_cf.train_(factors=200,iterations=100,regularization=0.01,alpha=10,show_progress=False)
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    result = model_cf.recommend_(int(userId))
